...
const UploadSubCategoryModel = ({close, fetchData}) => {
    ...
    const handleUploadSubCategoryImage = async (e) => {
        ...
        try {
            setLoading(true); // Start loading for image
            ...
            setLoading(false); // End loading after image upload
        }
    };
                ...
                <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <button
                        className={`px-4 py-2 border
                            ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category.length > 0 ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-200"}    
                            font-semibold
                        `}
                        disabled={loading || !subCategoryData?.name || !subCategoryData?.image || subCategoryData?.category.length === 0}
                    >
