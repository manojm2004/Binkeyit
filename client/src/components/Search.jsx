...
const Search = () => {
    ...
    const [searchTerm, setSearchTerm] = useState("");  // Added state to manage search input
    ...
    const handleOnChange = (e) => {
        ...
        navigate(url); // Navigate to the updated search URL
    };
                    ...
                    !isSearchPage ? (
                        ...
                        <div className="w-full h-full">
                            <input
                                ...
                                autoFocus
                                value={searchTerm} // Bind the state to the input field
